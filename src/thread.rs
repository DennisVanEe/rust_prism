    ...
    RenderThreadPool<'a, C, S, I, T>
{
    ...
    pub fn start_render(&mut self) {
        ...
        let main_tile = self.tile_schedular.init_index();
        ...
        // TODO: main performs it's own threading work here:
    ...
    RenderThread<'a, C, S, I, T>
{
    ...
    fn start_render(&mut self, tile_index: TileIndex) {
        // TODO: add the spawn thread function here:
    }
